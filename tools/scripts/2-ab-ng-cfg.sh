...
json -I -f angular.json -e "this.schematics['@nrwl/angular:application'].prefix = 'rsrch';"
...
json -I -f angular.json -e "this.schematics['@nrwl/angular:library'].prefix = 'rsrch';"
